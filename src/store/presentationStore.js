...
export const CAMERA_CONFIG = [
  ...
  { position: [0,  -3,  11], target: [0, -1,  0] },  // 10 Base de Datos
  { position: [3,   1,   9], target: [1,  0,  0] },  // 11 API
  { position: [0,   0,  12], target: [0,  0,  0] },  // 12 Cierre
  { position: [0,   0,  14], target: [0,  0,  0] },  // 13 Agradecimientos
]
